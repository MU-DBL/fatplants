...
@Component({
  ...
  templateUrl: './investigatorNew.component.html',
  styleUrls: ['./investigatorNew.component.scss']
})
export class InvestigatorNewComponent implements OnInit {
  ...
  ppl6 = "/app/assets/homepageAssets/CH.jpg";
  constructor() { }
